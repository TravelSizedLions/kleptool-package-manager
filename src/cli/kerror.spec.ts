...
describe('boundary function', () => {
  ...
  it('should handle non-Error throws', async () => {
    __testBoundaryThrow('string error', processExitSpy, consoleSpy, [
      'unexpected not-an-error received',
      'string error',
    ]);
  });

  it('should handle regular Error instances', async () => {
    __testBoundaryThrow(new Error('regular error'), processExitSpy, consoleSpy, [
